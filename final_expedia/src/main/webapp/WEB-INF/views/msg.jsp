...
<script type="text/javascript">
	...
	location.href = "${requestScope.loc}"; //자바에서 페이지 이동
	
	// 팝업창이 아니라 부모창을 새로고쳐야한다.
	opener.location.reload(true); // 부모창 새로고침. opener. 가 팝업창을 여는 곳이다.(부모)
	// 또는 opener.history.go(0);// 부모창 새로고침
